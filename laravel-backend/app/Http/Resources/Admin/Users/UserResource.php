...
// use App\Models\Consulation; // Đã xóa vì chức năng này chưa hoàn thành
use Carbon\Carbon;
...
class UserResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        // Đã xóa các tính toán consultations vì chức năng này chưa hoàn thành
        $shifts = [];
        $shifts_after = [];
        $shifts_before = [];
        $treatmentHistories = [];
        ...
        return [
            ...
            // Đã xóa countConsulation vì chức năng này chưa hoàn thành
            'countConsulation_today' => 0,
            'countConsulation_week' => 0,
            'countConsulation_month' => 0,
    ...
    // Đã xóa countConsulationWeek vì chức năng này chưa hoàn thành
    ...
    // Đã xóa countConsulationMonth vì chức năng này chưa hoàn thành
