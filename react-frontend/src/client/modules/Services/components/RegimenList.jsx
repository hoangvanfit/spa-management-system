        ...
        <div className={style.boxTitleRegimen}>
            <Row justify={"center"}>
                <Col xl={18} lg={16} md={18} sm={22} xs={24}>
                    <h4 >
                        Tại May Beauty Spa, bạn sẽ được tư vấn - thăm khám - điều trị mụn trực tiếp cùng bác sĩ da liễu vững vàng chuyên môn,
                    ...
                    <Row justify={"center"} gutter={[24, 24]}>
                        <Col xl={8} xs={24}>
                            <div className={style.boxRegimenItem}>
                                ...
                                <div className={style.boxRegimenItemBottom}>
                                    Đội ngũ bác sĩ Da liễu May Beauty Spa có nhiều năm kinh nghiệm thăm khám và điều trị mụn chuyên sâu, giúp bạn xác định tình trạng và nguyên nhân gây mụn, thiết lập phác đồ điều trị phù hợp, điều trị đúng ngay từ đầu và sớm mang lại hiệu quả
                                </div>
                            </div>
                        </Col>{" "}
                        <Col xl={8} xs={24}>
                        ...
                        <Col xl={8} xs={24}>
                            <div className={style.boxRegimenItem}>
                                ...
                                <div className={style.boxRegimenItemBottom}>
                                    May Beauty Spa thiết kế liệu trình điều trị cá nhân hóa, chỉ tư vấn sản phẩm cần thiết, không chèo kéo nhằm giúp khách hàng tiết kiệm chi phí và công sức, đặc biệt phù hợp học sinh – sinh viên.
                                </div>
                            </div>
                        </Col>{" "}
                        <Col xl={8} xs={24}>
                            <div className={style.boxRegimenItem}>
                                ...
                                <div className={style.boxRegimenItemBottom}>
                                    May Beauty Spa đồng hành và sẵn sàng tư vấn cặn kẽ, cung cấp cho khách hàng kiến thức đúng về nguyên nhân gây ra mụn, cũng như cách kiểm soát và ngăn ngừa chúng tái phát sau này.
                                </div>
                            </div>
                        </Col>{" "}
                    </Row>
