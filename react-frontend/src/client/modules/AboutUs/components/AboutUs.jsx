            ...
            <Row justify="center" style={{ width: '100%' }}>
                <Col className={style.aboutContent}
                    ...
                    <div className={style.boxContentLeft}>
                        ...
                        <p className={style.textContent}>Đến năm 2030, May Beauty Spa trở thành hệ thống phòng khám da liễu chuyên trị mụn hàng đầu Việt Nam, mỗi ngày tiếp nhận và giúp đỡ cho hơn 10.000 bạn trẻ được trị mụn chuẩn Y khoa.</p>
                    </div>
            ...
            {/* <Row justify="center" style={{ width: '100%' }}>
                <Col className={style.aboutContentMiddle}
                    ...
                    <div className={style.boxContentRight}>
                        ...
                        <p className={style.textContent}>Giá trị cốt lõi hàng đầu của May Beauty Spa là trung thực với khách hàng. Phòng khám cam kết tư vấn trung thực về hiệu quả điều trị, đồng thời chỉ tư vấn phương pháp và sản phẩm thực sự cần thiết cho khách hàng.</p>
                    </div>
                    <div className={style.boxContentRight}>
                        <div className={style.boxContentTop}>
                            <img src={doctor} alt="" width={'40px'} /><h2 className={style.title}>Chuẩn Y Khoa</h2>
                        </div>
                        <p className={style.textContent}>May Beauty Spa theo đuổi phương châm điều trị dựa trên căn cứ y học và bằng chứng lâm sàng. Vì thế, tất cả các phương pháp và sản phẩm trị mụn được chọn lựa sử dụng tại May Beauty Spa đều đảm bảo chuẩn y khoa, an toàn và hiệu quả cho khách hàng.</p>
                    </div>
                    <div className={style.boxContentRight}>
                        <div className={style.boxContentTop}>
                            <img src={health} alt="" width={'40px'} /><h2 className={style.title}>Liên Tục Cải Tiến</h2>
                        </div>
                        <p className={style.textContent}>Góp ý từ khách hàng là những điều May Beauty Spa thật sự trân trọng. Đây là động lực để phòng khám không ngừng cập nhật, đổi mới phương pháp điều trị mụn tiên tiến, chuẩn y khoa nhằm nâng cao chất lượng dịch vụ ngày một tốt hơn.</p>
                    </div>
                </Col>
            </Row> */}
                ...
                >
                    <div className={style.boxContentRight}>
                        ...
                        <p className={style.textContent}>
                            Giá trị cốt lõi hàng đầu của May Beauty Spa là trung thực với khách hàng.
                    ...
                    <div className={style.boxContentRight}>
                        ...
                        <p className={style.textContent}>
                            May Beauty Spa theo đuổi phương châm điều trị dựa trên căn cứ y học và bằng
                            chứng lâm sàng. Vì thế, tất cả các phương pháp và sản phẩm trị mụn được
                            chọn lựa sử dụng tại May Beauty Spa đều đảm bảo chuẩn y khoa, an toàn và
                    ...
                    <div className={style.boxContentRight}>
                        ...
                        <p className={style.textContent}>
                            Góp ý từ khách hàng là những điều May Beauty Spa thật sự trân trọng. Đây là
