                ...
                >
                    <div className={style.textContent}>
                        ...
                        <h1 className={style.title}>
                            Giới Thiệu Phòng Khám Da Liễu May Beauty Spa
                        </h1>
                        <p className={style.description}>
                            Nhận thấy nhiều bạn trẻ tự điều trị mụn sai cách, luôn phải chật
                            vật với nỗi lo lắng về làn da kém thẩm mỹ, May Beauty Spa đã ra đời với
                            mong muốn giúp các bạn được điều trị mụn hiệu quả và khoa học.
                        </p>
                        <p className={style.description}>
                            Tháng 2/2015, Phòng Khám May Beauty Spa được Sở Y tế cấp phép hoạt động
                            và trở thành địa chỉ tiên phong Chuyên điều trị mụn chuẩn Y khoa.
                            Sau hơn 9 năm theo đuổi sứ mệnh, May Beauty Spa đã giúp cho hơn 489.000
