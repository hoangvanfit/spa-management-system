    ...
    return (
        <section className="container p-5">
            <Divider orientation="left">
                <h2>Giới thiệu về May Beauty Spa</h2>
            </Divider>
                    ...
                    <Row gutter={[16, 16]}>
                        ...
                        <Col xs={24} md={12}>
                            <p className={styles["image-text"]}>
                                May Beauty Spa chú trọng tạo môi trường thư giãn,
                    ...
                    <Row gutter={[16, 16]}>
                        <Col xs={24} md={12}>
                            <p className={styles["image-text"]}>
                                ...
                                May Beauty Spa cam kết mang lại sự hài lòng cho
                                khách hàng.
                            </p>
                        </Col>
                        <Col xs={24} md={12}>
                ...
                <Col xs={24} md={12}>
                    <Row justify={"center"} align={"middle"}>
                        <Col span={24} className={styles.logo}>
                            ...
                            <h1 className={styles["spa-name"]}>MAY BEAUTY SPA</h1>
                        </Col>
                        <Button
                            type="primary"
                        ...
                        >
                            Tìm hiểu về May Beauty Spa <ArrowRightOutlined />
                        </Button>
                    </Row>
                </Col>
            </Row>
