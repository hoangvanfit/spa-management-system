...
import { CarryOutFilled, FieldTimeOutlined, MoneyCollectFilled } from '@ant-design/icons';
...
import useBootstrapUtils from '../../../../admin/modules/home/hooks/useBootstrapUtils';
const settings = {
     dots: false,
     infinite: true,
     speed: 500,
                         ...
                         <Slider {...settings}>
                              {servicesClient.map((item, index) => (
                                             ...
                                             <Image
                                                  ...
                                                  src={
                                                      ...
                                                      item.image_url !== undefined
                                                          ? `${URL_IMAGE}/services/special/${item.image_url}`
                                   ...
                                   >
                                        ...
                                        <Tooltip trigger="click" title={`Thời gian điều trị: ${item.duration}`}>
                                             <Button className={styles.tooltipButton}>
                                                  <FieldTimeOutlined />
                                                  <strong>Thời gian điều trị</strong>
                                             </Button>
                                        </Tooltip>
                                        <Tooltip trigger="click" title={`Chi phí dự kiến: ${parseInt(item.price).toLocaleString()} VNĐ`}>
                                             <Button className={styles.tooltipButton}>
                                                  <MoneyCollectFilled />
