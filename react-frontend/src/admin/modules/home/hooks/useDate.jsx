...
const useDate = (initialDate = null) => {
    // Nếu không có initialDate, mặc định là ngày 14 của tháng hiện tại
    // hoặc ngày hiện tại nếu ngày hiện tại < 14
    const getDefaultDate = () => {
        ...
        // Nếu ngày hiện tại > 14, mặc định là ngày 14
        // Nếu ngày hiện tại <= 14, dùng ngày hiện tại
        if (currentDay > 14) {
            return new Date(currentYear, currentMonth, 14);
        }
        return today;
    };
