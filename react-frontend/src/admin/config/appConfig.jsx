...
const API_BASE_URL_PROD = import.meta.env.VITE_API_BASE_URL || "https://your-app-name.up.railway.app/api/v0.0.1/admin";
const API_AUTH_URL_PROD = import.meta.env.VITE_API_AUTH_URL || "https://your-app-name.up.railway.app/api/auth";
const API_AUTHCUSTOMER_URL_PROD = import.meta.env.VITE_API_AUTH_CUSTOMER_URL || "https://your-app-name.up.railway.app/api/authCustomer";
const API_AUTH_URL2_PROD = import.meta.env.VITE_API_AUTH_URL2 || "https://your-app-name.up.railway.app/api";
const API_AUTH_URL3_PROD = import.meta.env.VITE_API_AUTH_URL3 || "https://your-app-name.up.railway.app/api/v0.0.1/client";
const URL_IMAGE_PROD = import.meta.env.VITE_URL_IMAGE || "https://your-app-name.up.railway.app/storage/uploads";
const URL_IMAGE_2_PROD = import.meta.env.VITE_URL_IMAGE_2 || "https://your-app-name.up.railway.app/storage";

// Development URLs
const API_BASE_URL_DEV = "http://127.0.0.1:8000/api/v0.0.1/admin";
const API_AUTH_URL_DEV = "http://127.0.0.1:8000/api/auth";
const API_AUTHCUSTOMER_URL_DEV = "http://127.0.0.1:8000/api/authCustomer";
const API_AUTH_URL2_DEV = "http://127.0.0.1:8000/api";
const API_AUTH_URL3_DEV = "http://127.0.0.1:8000/api/v0.0.1/client";
const URL_IMAGE_DEV = "http://127.0.0.1:8000/storage/uploads";
const URL_IMAGE_2_DEV = "http://127.0.0.1:8000/storage";

// Chọn URL dựa trên environment
const isDevelopment = import.meta.env.DEV;

export const API_BASE_URL = isDevelopment ? API_BASE_URL_DEV : API_BASE_URL_PROD;
const API_AUTH_URL = isDevelopment ? API_AUTH_URL_DEV : API_AUTH_URL_PROD;
const API_AUTHCUSTOMER_URL = isDevelopment ? API_AUTHCUSTOMER_URL_DEV : API_AUTHCUSTOMER_URL_PROD;
const API_AUTH_URL2 = isDevelopment ? API_AUTH_URL2_DEV : API_AUTH_URL2_PROD;
const API_AUTH_URL3 = isDevelopment ? API_AUTH_URL3_DEV : API_AUTH_URL3_PROD;
export const URL_IMAGE = isDevelopment ? URL_IMAGE_DEV : URL_IMAGE_PROD;
export const URL_IMAGE_2 = isDevelopment ? URL_IMAGE_2_DEV : URL_IMAGE_2_PROD;
...
const endpoints = {
     ...
     Users: {
          ...
          detail: (id) => `${API_BASE_URL}/users/${id}?shifts=true&shifts_after=true&shifts_before=true&appointments=true&cosulations=true&treatmentHistories=true`,
     ...
     services: {
          ...
          detailClient: (id) => `${API_AUTH_URL3}/services/${id}?products=true&serviceImages=true&comments=true&image_url=true`,
          listAvailableImages: `${API_BASE_URL}/services/images/list`,
     },
     shifts: {
     ...
     statistical: {
          monthlyRevenues: (data) => `${API_BASE_URL}/statistical/monthlyRevenues?year=${data.year}&month=${data.month}`,
          weeklyRevenues: (data) => `${API_BASE_URL}/statistical/weeklyRevenues?year=${data.year}&week=${data.week}`,
          dailyRevenues: (data) => `${API_BASE_URL}/statistical/dailyRevenues?day=${data.day}`,
          revenueAppointment: (data) => `${API_BASE_URL}/statistical/appointments?day=${data.day}`,
          revenueConsulation: (data) => `${API_BASE_URL}/statistical/consulations?day=${data.day}`,
          staffConsulations: (data) => `${API_BASE_URL}/statistical/staffConsulations?day=${data.day}`,
          staffAppoiments: (data) => `${API_BASE_URL}/statistical/staffAppoiments?day=${data.day}`,
     },
     contacts: {
